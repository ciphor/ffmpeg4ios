...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/opt/ffmpeg-0.7-new --disable-encoders --disable-hwaccels --disable-muxers --disable-demuxers --disable-bsfs --disable-protocols --disable-devices --disable-filters --enable-static --disable-shared --enable-pthreads --enable-memalign-hack --enable-decoder=h264 --enable-parser=h264 --arch=x86 --target-os=mingw32
...
SRC_PATH="/home/wl/source/ffmpeg-0.7"
SRC_PATH_BARE=/home/wl/source/ffmpeg-0.7
BUILD_ROOT="/home/wl/source/ffmpeg-0.7"
...
LN_S=ln -sf
STRIP=strip
CPPFLAGS=-I/local/include -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -U__STRICT_ANSI__
...
ASFLAGS=   -g
CC_O=-o $@
LDFLAGS=-L/local/lib -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil
...
EXTRALIBS=-lws2_32 -lm -lpthread -lz -lpsapi 
INSTALL=install
LIBTARGET=i386
...
libavutil_VERSION=51.0.0
libavutil_VERSION_MAJOR=51
libavfilter_VERSION=2.0.0
